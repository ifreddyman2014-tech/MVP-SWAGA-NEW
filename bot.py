...
INSTRUCTION_TEXT = (
    ...
    "<b>📱 Android / iOS:</b>\n"
    "1. Скачайте приложение <b>V2RayTun</b> (кнопки ниже)\n"
    "2. Нажмите «Личный кабинет» → «Быстрое подключение»\n"
    "3. Конфигурация импортируется автоматически\n\n"
    "<b>💻 Windows / macOS:</b>\n"
    "1. Скачайте <a href='https://github.com/2dust/v2rayN/releases'>v2rayN</a> (Win) "
    "или <a href='https://github.com/yanue/V2rayU/releases'>v2rayU</a> (Mac)\n"
